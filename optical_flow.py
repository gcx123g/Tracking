...
# 读取相邻两张RGB图像
prev = cv2.imread(r"E:/data/GOT-10K/test/GOT-10k_Test_000092/00000004.jpg", cv2.IMREAD_UNCHANGED)
next = cv2.imread(r"E:/data/GOT-10K/test/GOT-10k_Test_000092/00000005.jpg", cv2.IMREAD_UNCHANGED)
...
# 光流提取
flows = cv2.calcOpticalFlowFarneback(prev_img, next_img, None, pyr_scale=0.5, levels=3, winsize=55, iterations=3,
